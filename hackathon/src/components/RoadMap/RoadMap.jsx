      ...
      <div className="maincontainer">
        <div className="wrapper">
          ...
          <p className="description">
            We’ve created the steps needed to get your business regulated
          </p>
          <div className="container">
            <div className="container__left-pannel">
              <div className="container__details-card">
                <div className="container__img-sec">
                  ...
                  <h2 className="container__card-title">
                    Register your business name
                  </h2>
                </div>
                <div className="container__des-pannel">
                  <p className="container__card-description">
                    Register your business name through the BC registry
                    Services.
                  </p>
                </div>
              ...
              <div className="container__details-card">
                <div className="container__img-sec">
                  ...
                  <h2 className="container__card-title">
                    Suggested Insurance (Optional)
                  </h2>
                </div>
                <div className="container__des-pannel">
                  <p className="container__card-description">
                    Consider getting business insurance for your distribution
                    process.
                  </p>
                </div>
                <div className="container__btn-pannel">
            ...
            <div className="container__right-pannel">
              ...
              <div className="container__details-card">
                ...
                <div className="container__des-pannel">
                  <p className="container__card-description">
                    Register for the Provincial Sales Tax (PST) with BC Minister
                    of Finance..
                  </p>
                </div>
                <div className="container__btn-pannel">
              ...
              <div className="container__details-card">
                ...
                <div className="container__des-pannel">
                  <p className="container__card-description">
                    We suggest incorporating your business to protect your
                    personal funds.
                  </p>
                </div>
                <div className="container__btn-pannel">
